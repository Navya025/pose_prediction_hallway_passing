...
set_target_properties(Ceres::ceres PROPERTIES
  ...
  INTERFACE_LINK_LIBRARIES "/usr/lib/x86_64-linux-gnu/libglog.so;gflags;\$<LINK_ONLY:Threads::Threads>;\$<LINK_ONLY:SuiteSparse::CHOLMOD>;\$<LINK_ONLY:SuiteSparse::SPQR>;\$<LINK_ONLY:CUDA::cublas>;\$<LINK_ONLY:CUDA::cudart>;\$<LINK_ONLY:CUDA::cusolver>;\$<LINK_ONLY:CUDA::cusparse>;\$<LINK_ONLY:Ceres::ceres_cuda_kernels>;/usr/lib/x86_64-linux-gnu/liblapack.so;/usr/lib/x86_64-linux-gnu/libblas.so;/usr/lib/x86_64-linux-gnu/libf77blas.so;/usr/lib/x86_64-linux-gnu/libatlas.so;Eigen3::Eigen"
)
