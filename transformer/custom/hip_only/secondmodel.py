# version of model.py that only outputs the pelvis joint
...
class PosePredictionTransformer(nn.Module):
    ...
    def __init__(self, num_layers, d_model, num_heads, num_features=7, seq_len=num_frames):
        ...
        # Output a num_framesx3 matrix, using a time-distributed-like linear layer
    ...
    def forward(self, x, mask=None):
        ...
        for i in range(self.seq_len):
            ...
            outputs.append(out)
        # Stack the outputs to get a [batch_size, seq_len, num_joints] tensor
